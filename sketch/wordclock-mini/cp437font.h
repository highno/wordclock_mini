...
const byte cp437_fontsize [] PROGMEM = { 
  // this array defines per character of the font:
  // first nibble: which column to start with ...
  // second nibble: how many columns to use ...
  //  ... when using proportional mode
  0x08,
  0x08,
  0x08,
  0x07,
...
// this array defines the bitfont data and was heavily modified by me to a better readability
