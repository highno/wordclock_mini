...
public:
     ...
     */
    void drawText();
    void drawTextProportional();
      
    /**
     * Set the current text.
     */
    void setText(String text);
    void setTextProportional(String text);
    ...
    /**
     * Disables and enables the framebuffer output to the displays (and clearing it on mute).
     */
    void mute();
    void unmute();
    ...
    void scrollTextRightProportional();
    
    /**
     * Scroll the text to the left.
     */
    void scrollTextLeft();
    void scrollTextLeftProportional();
    
    /**
     * Oscilate the text between the two limits.
     */
    void oscillateText();
    void oscillateTextProportional();

    /**
     * Calculate text width in pixels for proportional font.
     */
    int textLengthProportional(String text);

    /**
     * Returns true if a newly set text has scrolled once.
     */
